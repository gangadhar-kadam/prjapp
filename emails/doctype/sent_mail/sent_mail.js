...
wn.provide("erpnext.sent_mail");


// TODO commonify this code
erpnext.sent_mail.SentMail = wn.ui.form.Controller.extend({
	customer: function() {
		var me = this;
...
$.extend(cur_frm.cscript, new erpnext.sent_mail.SentMail({frm: cur_frm}));
...
$.extend(cur_frm.cscript, {
	...
	make_listing: function(doc) {
		...
		var comm_list = wn.model.get("Communication", {"parent": doc.name, "parenttype":"Sent Mail"})
